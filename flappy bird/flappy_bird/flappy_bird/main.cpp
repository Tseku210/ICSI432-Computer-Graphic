...
unsigned int mario, bird2, question, enemy;
...
void init() {
    ...
    mario = loadTexture("../images/yellowbird-upflap.bmp");
    bird2 = loadTexture("../images/yellowbird-midflap.bmp");
    castle = loadTexture("../images/castle.bmp");
//    castle = loadTexture("/Users/tsenguunotgonbaatar/Documents/computer_graphics/mario/images/castle.bmp");
//    question = loadTexture("../media/bmps/question.bmp");
//    cloud = loadTexture("/Users/tsenguunotgonbaatar/Documents/computer_graphics/mario/images/cloud.bmp");
//    bush = loadTexture("../media/bmps/bush.bmp");
//    hill = loadTexture("../media/bmps/hill.bmp");
//    pipe = loadTexture("../media/bmps/pipe.bmp");
//    enemy = loadTexture("/Users/tsenguunotgonbaatar/Documents/computer_graphics/mario/images/enemy.bmp");
}
...
//        output(visibleTileX, visibleTileY, 0.0f, 0.0f, 0.0f, GLUT_BITMAP_8_BY_13, inst);
//        output(visibleTileX, visibleTileY, 0.0f, 0.0f, 0.0f, GLUT_BITMAP_HELVETICA_10, "Press Space");
...
//                    drawCloud(x * tileWidth - tileOffsetX, y * tileHeight - tileOffsetY, (x+2)*tileWidth - tileOffsetX, (y+1)*tileHeight - tileOffsetY);
                    break;
            case '$':
...
//                    updateEnemy(x, y);
            ...
            case '&':
                    pipeReverse = 0;
//                    fill(pipetop, x * tileWidth - tileOffsetX, y * tileHeight - tileOffsetY, (x+1)*tileWidth - tileOffsetX, (y+1)*tileHeight - tileOffsetY, 0.8f, 0.0f, 0.0f);
